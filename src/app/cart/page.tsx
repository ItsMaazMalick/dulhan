                  ...
                  {cartItems.map((item, index) => (
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                        ...
                        {/* Quantity */}
                        <div className="flex items-center gap-3 border border-gray-700 hover:border-primary w-fit px-4 py-2 rounded transition-colors duration-300">
                          <button
                            onClick={() =>
                  ...
                  <div className="border-b border-gray-800 pb-6">
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 bg-transparent border border-gray-700 text-white px-3 py-2 text-sm focus:outline-none focus:border-primary focus:shadow-md focus:shadow-primary/20 transition-all placeholder-gray-600"
                      />
                      <button
                        onClick={handleApplyCoupon}
                        className="bg-gray-700 hover:bg-primary text-white px-4 py-2 text-sm transition-all duration-300 font-light hover:shadow-md hover:shadow-primary/20"
                      >
                        Apply
                      </button>
                    </div>
                    {couponApplied && (
                      <p className="text-xs text-primary mt-2 animate-slideInLeft">
